 ...
 *
 * @file
 * @brief       Shell commands for the ASYMCUTE module
 *
...
static void _asymcute_usage(char **argv)
{
    ...
    printf("%s unreg <topic name>\n", argv[0]);
    printf("%s pub <topic> <data> [QoS level]\n", argv[0]);
...
{
    if (argc < 2) {
        _asymcute_usage(argv);
        return 1;
    }
    if (strcmp(argv[1], "connect") == 0) {
        /* pass on to read handler, shifting the arguments by one */
        return _cmd_connect(argc - 1, &argv[1]);
    }
    else if (strcmp(argv[1], "disconnect") == 0) {
        return _cmd_disconnect(argc - 1, &argv[1]);
    }
    else if (strcmp(argv[1], "reg") == 0) {
        return _cmd_reg(argc - 1, &argv[1]);
    }
    else if (strcmp(argv[1], "unreg") == 0) {
        return _cmd_unreg(argc - 1, &argv[1]);
    }
    else if (strcmp(argv[1], "pub") == 0) {
        return _cmd_pub(argc - 1, &argv[1]);
    }
    else if (strcmp(argv[1], "sub") == 0) {
        return _cmd_sub(argc - 1, &argv[1]);
    }
    else if (strcmp(argv[1], "unsub") == 0) {
        return _cmd_unsub(argc - 1, &argv[1]);
    }
    else if (strcmp(argv[1], "info") == 0) {
        return _cmd_info(argc - 1, &argv[1]);
    }
