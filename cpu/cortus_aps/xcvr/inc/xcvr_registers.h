...
#define XCVR_CODEC_DETECTOR_CONFIG_SYNC_THRESHOLD_13          (0x00000D00)
#define XCVR_CODEC_DETECTOR_CONFIG_SYNC_THRESHOLD_15          (0x00000F00)


#define XCVR_CODEC_PACKET_CONFIG_PREAMBLE_THRESHOLD_MASK      (0xFFFFFF01)

#define XCVR_CODEC_DETECTOR_CONFIG_PREAMBLE_THRESHOLD_16      (0x00000020) // 16 symbols Default = 0x20 for [7-0] means 0x10 for [7-1]
#define XCVR_CODEC_DETECTOR_CONFIG_PREAMBLE_THRESHOLD_32      (0x00000040) // 32 symbols
#define XCVR_CODEC_DETECTOR_CONFIG_PREAMBLE_THRESHOLD_48      (0x00000060) // 48 symbols
#define XCVR_CODEC_DETECTOR_CONFIG_PREAMBLE_THRESHOLD_64      (0x00000080) // 64 symbols
#define XCVR_CODEC_DETECTOR_CONFIG_PREAMBLE_THRESHOLD_127     (0x000000FE) // 127 symbols
...
#define XCVR_BASEBAND_AGC_CONFIG_RSSI_HIGH_DEFAULT_THRESHOLD (0xFC0000) // FIXME set the default value
...
#define XCVR_BASEBAND_RSSI_CONFIG_TIMEOUT_TIMER_DEFAULT            (0x00FF0000)
