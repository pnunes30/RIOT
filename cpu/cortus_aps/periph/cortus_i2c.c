...
#ifdef USE_PERIPH_CORTUS_I2C   //FIXME: I2C to be validated explicitly
...
void i2c_write(i2c_handle_t* handle, uint8_t to, uint8_t* payload, int length) {
    int i;
#if defined(FRAMEWORK_LOG_ENABLED)
...
void i2c_read(i2c_handle_t* handle, uint8_t to, uint8_t* payload, int length) {
    int i;
#if defined(FRAMEWORK_LOG_ENABLED)
...
void i2c_write_read(i2c_handle_t* handle, uint8_t to, uint8_t* payload, int length, uint8_t* receive, int receive_length)
{
